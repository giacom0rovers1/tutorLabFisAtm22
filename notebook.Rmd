...
Tramite il pacchetto `readr` (incluso in `tidyerse`), le colonne "Date" e "Time" possono essere già importate rispettivamente come date e orari (formati specifici). In questo modo facilitiamo le operazioni sugli intervalli temporali (i giorni del calendario e le ore del giorno vengono gestite in automatico). Il metodo è robusto perché ho preso i nomi delle colonne direttamente dal file, quindi non rischio di sbagliare l'ordine.
...
TODO Inserire exploratory graphs (istogrammi, ecc...) ma solo come esempi da personalizzare
