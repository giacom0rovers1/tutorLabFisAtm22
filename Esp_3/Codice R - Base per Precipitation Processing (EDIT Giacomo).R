...
rootFolder <- "~/Insync/giacomo.roversi2@studio.unibo.it/OneDrive Biz - Shared/Laboratorio di Fisica dell'Atmosfera/Studenti_Esp3/"
setwd(rootFolder)

figfolder <- "~/tutorLabFisAtm22/Esp_3/figure/"
...
PlotSAT <- function(tt,minLON,maxLON,minLAT,maxLAT,BG) {
  tt <- tt+2
...
png(filename = paste0(figfolder, "PlotSAT.png"),
    width    = 480,
    height   = 322,
    units    = "px")
...
png(filename = paste0(figfolder, "PixBOR.png"),
    width    = 480,
    height   = 322,
    units    = "px")
...
png(filename = paste0(figfolder, "PlotPLV.png"),
    width    = 480,
    height   = 322,
    units    = "px")
...
png(filename = paste0(figfolder, "PlotGPM.png"),
    width    = 480,
    height   = 322,
    units    = "px")
...
png(filename = paste0(figfolder, "PlotERA.png"),
    width    = 480,
    height   = 322,
    units    = "px")
...
png(filename = paste0(figfolder, "domain.png"),
    width    = 480,
    height   = 322,
    units    = "px")
...
png(filename = paste0(figfolder, "gridpoints.png"),
    width    = 480,
    height   = 322,
    units    = "px")
...
png(filename = paste0(figfolder, "PlotGRID.png"),
    width    = 480,
    height   = 322,
    units    = "px")
...
png(filename = paste0(figfolder, "PlotALL.png"),
    width    = 480,
    height   = 322,
    units    = "px")
...
outDIR <- paste0(figfolder, "GPM_",tGPM[1],"_",tGPM[length(tGPM)])
dir.create(outDIR)
